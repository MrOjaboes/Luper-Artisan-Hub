    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">New Proffession</h5>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" required wire:model="title"
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="store()" class="btn btn-success close-modal">Add Proffession</button>
            </div>
        </div>
    </div>
</div>
